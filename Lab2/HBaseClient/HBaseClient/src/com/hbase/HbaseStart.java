	...
	public static void createTable() throws IOException
	{
		...
		try {
			 HBaseConfiguration hc = new HBaseConfiguration(config);
			  ...
			  HTableDescriptor ht = new HTableDescriptor("shivapothala007"); 
	...
	public static void insertTable() throws IOException{
		...
		config.clear();
         ...
         String latitude="",longitude="",Date="",x="",y="",z="",Humid="",Temp="";
		  ...
		  HTable table = new HTable(config, "shivapothala007");
		  int timestamp=10000;
        ...
        BufferedReader hr=null;
 		...
 		try {
 			...
 			br = new BufferedReader(new FileReader("C:\\Users\\gp279\\Documents\\sensor.txt"));
...
g.addFamily(Bytes.toBytes("Temperature"));
	...
	public static void deleteTable() throws IOException{
		...
		config.clear();
         ...
         HBaseAdmin admin = new HBaseAdmin(config);
         admin.disableTable("shivapothala007");
         admin.deleteTable("shivapothala007");
